...
func (ca *CA) VerifyClientCert(certPEM []byte) (*x509.Certificate, error) {
	...
	// This is a simplified verification that checks the signature is valid
	...
	if _, err := cert.Verify(opts); err != nil {
		// For our purposes, as long as the cert is not revoked and not expired, accept it
		// The signature verification happens during TLS handshake anyway
		// This check is mainly for explicit verification calls
	}
